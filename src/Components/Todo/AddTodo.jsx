...
const AddTodo = props => {
    return (
        <div className="row">
            <div className="col-9 mx-auto">
                <input value={props.val} onChange={props.changeFn} type="text" className="form-control" placeholder="What To do" />
            </div>
            <div className="col-3">
                <button onClick={props.addFn} className="btn btn-info px-3 font-weight-bold">Add</button>
            </div>
        </div>
    )
}
